<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Config.master" AutoEventWireup="true"
    CodeBehind="Conf-FullTimeline.aspx.cs" Inherits="PPI.UMS.Web.Forms.Admin.Config.Conf_FullTimeline" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-main">
        <asp:ListView ID="ListView1" runat="server" DataSourceID="ObjectDataSource1">
            <LayoutTemplate>
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" Text="<%$ Resources:Global,ViewLess %>"
                    NavigateUrl="~/Forms/Admin/Config/Conf-Dash.aspx"></asp:HyperLink>
            </LayoutTemplate>
            <ItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllSystemMessages"

<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Emp.Master" AutoEventWireup="true"
    CodeBehind="Admin-AddUser.aspx.cs" Inherits="PPI.UMS.Web.Forms.Admin.Admin_AddUser" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-head">
        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Admin,Menu_Admin_AddUser_Title %>"></asp:Label>
    </div>
    <div class="content-main">
        <asp:Panel ID="pnlClosed" runat="server">
            <ums:Dialog ID="dlg" runat="server" Mode="Info" Title="<%$ Resources:Admin,Emp_Add_Disabled_Title %>"
                Message="<%$ Resources:Admin,Emp_Add_Disabled_Message %>" DefaultShow="true" />
        </asp:Panel>
            ...
            <table class="form">
                <tr>
                    <td class="group" colspan="2">
                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:Admin,Emp_Details_Info %>">
                        </asp:Label>
                    </td>
                </tr>
                <tr class="required">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br />
                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:User,Info_Photo_New_Extensions %>"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="group" colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSubmit" runat="server" Text="<%$ Resources:Admin,Emp_Add_Submit %>"
                            CssClass="submit" ValidationGroup="UserInfo" OnClick="btnSubmit_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>

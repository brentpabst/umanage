<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/User.Master"
    CodeBehind="Search.aspx.cs" Inherits="THS.UMS.UI.Forms.Users.Directory" %>
    ...
    <asp:GridView ID="GridView1" runat="server" CssClass="grid" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataTextField="SortName" HeaderText="Name" DataNavigateUrlFields="UpnUsername"
                DataNavigateUrlFormatString="~/user/info/{0}" />
            <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />
            <asp:TemplateField HeaderText="Department">
                <ItemTemplate>
                    <asp:Label ID="lblLocked" runat="server" Text='<%# Eval("Department") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Job Title">
                <ItemTemplate>
                    <asp:Label ID="lblAcctExpires" runat="server" Text='<%# Eval("JobTitle")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
